    ...
    <div class="container ca-header-bg-2">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-6 col-6">
                <!-- ca-logo -->
                <div class="ca-logo">
                    <a href="index-02.php"><img src="assets/img/logo/ca-logo2.1.png" alt=""></a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-6">
                ...
                <div class="ca-btn-header text-end d-none d-lg-block">
                    <a href="contact.php" class="ca-btn-primary-22">Get A Free Quote <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
    ...
    <div class="ca-offcanvas-wrapper">
        <div class="ca-offcanvas-header d-flex justify-content-between align-items-center mb-40">
            <div class="ca-offcanvas-logo">
                <a href="#"><img src="assets/img/logo/ca-logo2.2.png" alt=""></a>
            </div>
